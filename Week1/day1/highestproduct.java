...
public class Solution {
    ...
    public static int highestProductOf3(int[] intArray) {
            ...
            int P1=(intArray[0] * intArray[1] * intArray[intArray.length - 1]);
            int P2=(intArray[intArray.length-1] * intArray[intArray.length-2] * intArray[intArray.length- 3]);

            // return Math.max(intArray[0] * intArray[1] * intArray[intArray.length - 1], intArray[intArray.length-1] * intArray[intArray.length-2] * intArray[intArray.length- 3]);
